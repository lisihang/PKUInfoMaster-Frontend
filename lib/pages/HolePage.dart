...
import 'package:flutter_app4/pages//HoleSearch.dart';
/*
...
Future<List<Hole>> fetchHole(http.Client client,String date) async {
  String url;
  if(date=='')
     url='http://132.232.131.25:8888/HOLE';
  else
     url = 'http://132.232.131.25:8888/HOLE'+'/'+date;
...
class HolePage extends StatefulWidget{
  @override
  _HolePageState  createState() => new _HolePageState();
}
class _HolePageState extends State<HolePage>{
  ...
  _textsubmitted(){
    ...
    {return new HoleSearch(searchController.text);}
    ));
  }
  @override
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: /*SearchBar(defaultBar: AppBar(
