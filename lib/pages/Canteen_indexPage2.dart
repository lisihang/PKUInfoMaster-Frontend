...
Future<List<Post>> fetchPost(http.Client client) async {
  ...
  url='http://132.232.131.25:8888/CANTEEN';
...
class Canteen_indexPage2 extends StatelessWidget {
  ...
  Canteen_indexPage2(this.pageText);    //构造函数，获取参数
            ...
            child: new ListView.builder(
              ...
              itemBuilder: (context,index){
                  ...
                  case 0:
                    return new Container(
                      ...
                      child: new Row(
                        ...
                        children: <Widget>[
                          new Image.asset('images/燕南食堂.jpg'),
                          new Container(
                            height: MediaQuery.of(context).size.height/10,
                            ...
                            child:new Column(
                              ...
                              children: <Widget>[
                                new Text("    就餐指数",style:  new TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
                    ...
                    return new Row(
                      ...
                      children: <Widget>[
                        new Container(
                          ...
                          child: new Text("拥挤排名",style: new TextStyle(fontWeight: FontWeight.bold),),
                        ),
                        new Container(
                          //height: 30,
                          //color: Colors.red,
                          width: MediaQuery.of(context).size.width / 4,
                          height: MediaQuery.of(context).size.height/25,
                          child: new Text("食堂",style: new TextStyle(fontWeight: FontWeight.bold),),
                        ),
                        new Container(
                          //color: Colors.red,
                          //height: 30,
                          width: MediaQuery.of(context).size.width / 4,
                          height: MediaQuery.of(context).size.height/25,
                          child: new Text("总容量",style: new TextStyle(fontWeight: FontWeight.bold),),
                        ),
                        new Container(
                          //color: Colors.red,
                          width: MediaQuery.of(context).size.width / 4,
                          height: MediaQuery.of(context).size.height/25,
                          //height: 30,
                          child: new Text("当前人数",style: new TextStyle(fontWeight: FontWeight.bold),),
                        ),
                      ],
                  ...
                  /*case 3:
                    return new Row(
                      ...
                      new Container(
                        ...
                        child: new Text((index-3).toString()),
                      ),
                new Container(
                  color: Colors.red,
                  width : MediaQuery.of(context).size.width/4,
                  height: MediaQuery.of(context).size.height/20,
                  child: new Text(posts[index-3].name.toString()),
                ),
                new Container(
                  color: Colors.red,
                  width : MediaQuery.of(context).size.width/4,
                ...
                new Container(
                  ...
                  height: MediaQuery.of(context).size.height/20,
                  color: Colors.red,
                  child: new Text(posts[index- 3].now.toString()),
                ),
                ],
                  ...
                  case 5:
                    ...
                    break;*/
                  default:
                    if(posts[index-3].now/posts[index-3].total>1.0)
                      return new Row(
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: <Widget>[
                          new Container(
                            ...
                            width : MediaQuery.of(context).size.width/4,
                            height: MediaQuery.of(context).size.height/20,
                            child: new Text((index-2).toString()),
                          ),
                          new Container(
                            color: Colors.red[700],
                            width : MediaQuery.of(context).size.width/4,
                    ...
                    else if(posts[index-3].now/posts[index-3].total>0.8)
                      return new Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: <Widget>[
                        new Container(
                    ...
                    else if(posts[index-3].now/posts[index-3].total>0.7)
                      return new Row(
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: <Widget>[
                          new Container(
                    ...
                    else if(posts[index-3].now/posts[index-3].total>0.6)
                      return new Row(
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: <Widget>[
                          new Container(
                    ...
                    else if(posts[index-3].now/posts[index-3].total>0.5)
                      return new Row(
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: <Widget>[
                          new Container(
                    ...
                    else if(posts[index-3].now/posts[index-3].total>0.4)
                      return new Row(
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: <Widget>[
                          new Container(
                    ...
                    else if(posts[index-3].now/posts[index-3].total>0.3)
                      return new Row(
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: <Widget>[
                          new Container(
