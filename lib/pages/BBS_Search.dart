...
Future<List<Post>> fetchPost(http.Client client,String date) async {
  ...
  if(date=='')
    ...
    url = 'http://132.232.131.25:8888/BBS'+'/SEARCH/'+date;
...
class BBS_Search extends StatelessWidget {
  //final Future<Post> post;
  final String pageText;    //定义一个常量，用于保存跳转进来获取到的参数
  BBS_Search(this.pageText);    //构造函数，获取参数
  @override
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(title: new Text("搜索结果"),),    //将参数当作页面标题
      body: new Center(
